...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(
        ...
        self.systrace_panel = SystracePanel(systrace_presenter, None, config_service.output_dir)
        self.perfetto_panel = PerfettoPanel(perfetto_presenter, None, config_service.output_dir)
        self.simpleperf_panel = SimpleperfPanel(simpleperf_presenter, None, config_service.output_dir)
        self.traceview_panel = TraceviewPanel(traceview_presenter, None, config_service.output_dir)
    ...
    def refresh_devices(self) -> None:
        ...
        worker = Worker(self.presenter.get_devices)
